...
public class MybatisPlusGenerator {
    static final String url = "jdbc:mysql://127.0.0.1:3306/bingo?serverTimezone=UTC";    // 数据库地址
        ...
        FastAutoGenerator.create(url, username, password)
                ...
                .packageConfig(builder -> {
                    builder.parent(parentPackageNameJava) // 设置父包名
                            ...
                            .pathInfo(Collections.singletonMap(OutputFile.xml, System.getProperty("user.dir") + "/src/" + parentPackageNameResource + "/mapper")); // 设置mapperXml生成路径
                })
                // 策略配置
